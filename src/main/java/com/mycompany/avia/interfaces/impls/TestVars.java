...
//        place1 = new Place();
//        place1.setId(1);
//        place1.setSeatLetter('A');
//        place1.setSeatNumber(1);
//        place1.setFlightClass(economClass);
//
//        place2 = new Place();
//        place1.setId(2);
//        place1.setSeatLetter('A');
//        place1.setSeatNumber(2);
//        place1.setFlightClass(economClass);
//
//
//        place3 = new Place();
//        place1.setId(3);
//        place1.setSeatLetter('B');
//        place1.setSeatNumber(1);
//        place1.setFlightClass(economClass);
//
//
...
//
//
//        flight1.setDateDepart(calendar1);
//        flight1.setDateCome(calendar1);
//
